...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        List<Property> properties = List.of(
                Property.builder().numberE9("E9-12340").address("Grypari 152").yearOfConstruction(2024)
                        .propertyType(PropertyType.MAISONETTE).propertyOwner(propertyOwners.get(0)).build(),
                Property.builder().numberE9("E9-12341").address("Kalypsous 59").yearOfConstruction(1960).
                        propertyType(PropertyType.APARTMENT).propertyOwner(propertyOwners.get(1)).build(),
                Property.builder().numberE9("E9-12342").address("Alexandras 23").yearOfConstruction(2000).
                        propertyType(PropertyType.DETACHED_HOUSE).propertyOwner(propertyOwners.get(2)).build(),
                Property.builder().numberE9("E9-12343").address("Kolonaki 18").yearOfConstruction(2010)
                        .propertyType(PropertyType.APARTMENT).propertyOwner(propertyOwners.get(3)).build(),
                Property.builder().numberE9("E9-12344").address("Panormou 34").yearOfConstruction(1985)
                        .propertyType(PropertyType.APARTMENT).propertyOwner(propertyOwners.get(4)).build(),
                Property.builder().numberE9("E9-12345").address("Nea Smyrni 45").yearOfConstruction(1995)
                        .propertyType(PropertyType.MAISONETTE).propertyOwner(propertyOwners.get(5)).build(),
                Property.builder().numberE9("E9-12346").address("Marousi 78").yearOfConstruction(1970)
                        .propertyType(PropertyType.DETACHED_HOUSE).propertyOwner(propertyOwners.get(6)).build(),
                Property.builder().numberE9("E9-12347").address("Glyfada 99").yearOfConstruction(2020)
